...
```{r}
german.credit[,c("Credit_risk","Foreign_worker")]
```

```{r}
german.credit[which(german.credit$Foreign_worker == "yes"),c("Credit_risk","Foreign_worker")]
```
...
```{r}
german.credit[which(german.credit$Foreign_worker == "yes"),]
```
